...
// Render termine le HTTPS en amont et transmet en HTTP interne à l'app :
// sans cette ligne, Express ne sait pas que la connexion est sécurisée
// et le cookie de session (secure:true) ne se pose jamais chez le client.
